...
@section('content')
   @include('website.shared.page-banner', ['title' => 'Product Search Page'])
                  ...
                  <div class="col-lg-9 col-md-9 col-12">
                     <div class="row">
                        @foreach($products as $product)
                           <div class="col-md-3 col-12 mb-5 pb-2">
                        ...
                        <div class="widget">
                           <form action="{{ route('ecm.products.search') }}" method="get">
                              <div class="input-group mb-3 border rounded">
                                 <input type="text" id="s" name="s" class="form-control border-0" placeholder="Search Keywords..." value="{{ request('s') }}">
