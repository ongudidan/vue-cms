...
@endphp
<section class="section @if($section->section_background_type === 'image-bg') section-bg @endif"
   ...
   >
      <div class="row">
               ...
               <div class="mb-3">
                  <div class="row">
                     ...
                     <div class="col-md-12" data-aos="zoom-in-up" data-aos-duration="1800" data-aos-delay="{{ ($key + 1) * 400 }}">
                        <div class="mb-3">
                           <div class="features feature-secondary rounded px-4 py-3 bg-white shadow border-0 d-flex align-items-center">
                              <div class="fea-icon rounded-circle bg-light text-dark" style="height:50px; width:50px;">
                                 <i class="mdi {{ $card->icon ?? '' }} "></i>
                              </div>
                              <div class="content flex-1 ms-3">
                                 <h5 class="text-dark">{{ $card->title }}</h5>
                                 <div class="details mt-2 mb-0">
                                    {!! $card->details !!}
                                 </div>
                              </div>
                           </div>
         ...
         <div class="col-lg-6">
            ...
            <div class="ms-lg-5 mb-3 section-title">
