    ...
    <div class="overflow-hidden rounded-xl border border-sidebar-border bg-card shadow-sm">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span v-if="event.details" class="mt-1 line-clamp-1 text-sm text-muted-foreground">
                                        {{ event.details }}
                                    </span>
                                </div>
                            </div>
        ...
        >
            ...
            <div class="flex items-center gap-2">
                <button
                    @click="goToPage(events.links[0]?.url)"
                ...
                <div class="flex gap-1">
                    <button
                        v-for="(link, index) in events.links.slice(1, -1)"
                        :key="index"
                ...
                <button
                    @click="goToPage(events.links[events.links.length - 1]?.url)"
