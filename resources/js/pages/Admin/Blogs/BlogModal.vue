...
// Watch for blog changes to populate form
watch(
    () => props.blog,
    (newBlog) => {
        if (newBlog) {
            ...
            form.details = newBlog.details || '';
            form.tags = newBlog.tags ? newBlog.tags.join(', ') : '';
            form.date = newBlog.date || '';
            form.active = newBlog.active;
            form.images = null;
            imagePreview.value = null;
            existingMedia.value = newBlog.media || [];
        } else {
            form.reset();
            imagePreview.value = null;
            existingMedia.value = [];
        ...
        <div class="w-full max-w-3xl rounded-xl border border-sidebar-border bg-card shadow-xl overflow-hidden">
            ...
            <form @submit.prevent="submit" class="p-6 max-h-[75vh] overflow-y-auto">
                <div class="space-y-4">
                    ...
                    <!-- Tags Field -->
                    <div>
                        <label for="tags" class="mb-1.5 block text-sm font-medium text-foreground">
                            Tags
                        </label>
                    ...
                    <!-- Date Field -->
                    <div>
                        <label for="date" class="mb-1.5 block text-sm font-medium text-foreground">
                            Date
                        </label>
