    ...
    <div class="overflow-hidden rounded-xl border border-sidebar-border bg-card shadow-sm">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span v-if="project.details" class="mt-1 line-clamp-1 text-sm text-muted-foreground">
                                        {{ project.details }}
                                    </span>
                                </div>
                            </div>
        ...
        >
            <div class="text-sm text-muted-foreground">
                Showing {{ (projects.current_page - 1) * projects.per_page + 1 }}
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="flex gap-1">
                    <button
                        v-for="(link, index) in projects.links.slice(1, -1)"
                        :key="index"
