...
* @see app/Http/Controllers/ProjectController.php:163
* @route '/admin/projects/{project}'
*/
...
* @see app/Http/Controllers/ProjectController.php:174
* @route '/projects/{slug}'
*/
...
const ProjectController = { index, store, update, destroy, show }
