...
* @see app/Http/Controllers/ClientController.php:11
* @route '/admin/clients'
*/
...
* @see app/Http/Controllers/ClientController.php:66
...
* @see app/Http/Controllers/ClientController.php:99
* @route '/admin/clients/{client}'
*/
...
const ClientController = { index, store, update, destroy }
