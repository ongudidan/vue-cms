...
* @see app/Http/Controllers/PageController.php:198
* @route '/{slug}'
*/
...
* @see app/Http/Controllers/PageController.php:179
* @route '/'
*/
...
const PageController = { index, store, update, destroy, show, showHomepage }
